...
<body class="m-0 p-0 bg-blue-200 h-full ">
    <div class="w-full h-screen flex justify-center items-center">
        <div class="flex w-[700px] h-auto bg-transparent">
        <div class="w-[650px] h-[550px] bg-white text-black box-border p-[30px] px-[40px] rounded-[10px] animate-border">
                ...
                <form class="mt-10" action="">
                    ...
                    <input class="w-full h-[50px] my-[10px] border-none border-b-2 border-black text-black text-[16px]" type="text" placeholder="Usuario">


                    <h2>Ingresa tu Contraseña : </h2>
                    <input class="w-full h-[50px] my-[10px] border-none border-b-1 border-black text-black text-[16px]" type="password" placeholder="Contraseña">

                    <button class="w-full h-[40px] my-[10px] border-none text-white outline-none 
                    text-black bg-[#53b1ec] text-[16px] rounded-[25px] hover:bg-[#3f8cb5] cursor-pointer" ><a class="cursor-pointer" href="{{ route('index') }}">Acceder</a></button>

                    <a class="block text-[16px] text-gray-500 mt-[5px] no-underline hover:text-black" href="#">¿Olvidaste tu contraseña?</a>
                    <a class="block text-[16px] text-gray-500 mt-[5px] no-underline hover:text-black" href="/registro.html">Registrate</a>
